...
public class App {
    ...
    private static String getDashboardHtml() {
        return "<!DOCTYPE html>" +
               ...
               "    <style>" +
               "        body { background-color: #0d1117; color: #ffffff; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }" +

               "        h1, h5, p { color: white !important; }" +

               "        .card { background-color: #161b22; border: 1px solid #30363d; border-radius: 10px; color: white; }" +
               ...
               "                <div class='card p-3'>" +
               "                    <h5>Build Stage</h5>" +
               "                    <p class='small' style='color:white;'>Maven Lifecycle: Package</p>" +
               ...
               "                <div class='card p-3'>" +
               "                    <h5>Security Scan</h5>" +
               "                    <p class='small' style='color:white;'>SonarQube & Trivy</p>" +
               "                    <div class='progress mb-2'><div class='progress-bar w-100'></div></div>" +
               ...
               "                <div class='card p-3'>" +
               "                    <h5>Deployment</h5>" +
               "                    <p class='small' style='color:white;'>Docker</p>" +
               "                    <div class='progress mb-2'><div class='progress-bar w-100'></div></div>" +
               ...
               "                [INFO] Image Pushed to DockerHub successfully ✅<br>" +
               "                [INFO] ------------------------------------------------------------------------<br>" +
